    ...
    return (
        <div className='sticky top-10 card card-compact'>
            ...
            <div className='flex flex-wrap justify-between text-black bg-slate-200 mx-2 sm:mx-5 rounded-md mt-10 py-3'>
                ...
                <div>
                    <p className='mr-3 text-xl font-bold'>26yrs</p>
            ...
            <div className="bg-slate-200 rounded-lg py-3 mt-5 mx-2 sm:mx-4">
                <button onClick={() => timeHandler(10)} className="btn btn-circle text-white mr-2 btn-active">10s</button>
                <button onClick={() => timeHandler(20)} className="btn btn-circle text-white mr-2">20s</button>
                <button onClick={() => timeHandler(30)} className="btn btn-circle text-white mr-2">30s</button>
                <button onClick={() => timeHandler(40)} className="btn btn-circle text-white mr-2">40s</button>
                <button onClick={() => timeHandler(50)} className="btn btn-circle text-white mr-2">50s</button>
            </div>
            <div>
                <h2 className='text-xl text-black sm:text-start ml-3 sm:ml-5 mt-8 font-bold'>Exercise Details</h2>
                <div className='text-start mx-2 sm:mx-4 mt-5'>
